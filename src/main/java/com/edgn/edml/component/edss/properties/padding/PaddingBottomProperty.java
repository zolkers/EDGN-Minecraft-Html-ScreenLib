...
public final class PaddingBottomProperty extends AbstractEdssProperty {
    ...
    public void apply(EdmlComponent component, String value, MinecraftRenderContext context) {
        if (component instanceof BoxModelComponent boxComponent) {
            ...
            Padding newPadding = new Padding(currentPadding.top(), currentPadding.right(), bottom, currentPadding.left());
